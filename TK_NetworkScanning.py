...
class ALL_IPtest(ttk.Frame):
    ...
    def __init__(self, parent, mainframe):
        ...
        self.Go_Scanning = ttk.Button(
            self, text="开始扫描", image=self.go_img, compound='left',command=lambda: self.Scanning_show())
        ...
        self.ScanViews.grid(column=30, row=4, sticky="ns")
        self.Scanning_L.grid(column=2, row=4, sticky="nwes", padx=5, pady=5)
        self.IPtest.grid(column=0, row=0, sticky="nwes", padx=5, pady=5)
        self.Get_IPtxt.grid(column=0, row=1, sticky="nwes", padx=5, pady=5)
        self.Go_Scanning.grid(column=0, row=2, sticky="nwes", padx=5, pady=5)
        self.Out_ScanningTxt.grid(
            column=0, row=3, sticky="nwes", padx=5, pady=5)
        self.TestView.grid(column=2, row=3, sticky="nwes", padx=5, pady=5)
